...
RESset_bell = pickle.load(open("../results/B_changing/bell","r"))
RESset_myo = pickle.load(open("../results/B_changing/myo","r"))
RESset_zero = pickle.load(open("../results/B_changing/zero","r"))
RESset_one = pickle.load(open("../results/B_changing/one","r"))
RESset_rnd = pickle.load(open("../results/B_changing/rnd","r"))
...
xlabel('Maximum charged energy $B$',fontsize=16)
ylabel('Charing rate',fontsize=16) # steady state
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.40,0.65), fontsize=12, ncol=2,fancybox=True,shadow=True)
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
