...
Vset_bell, Aset_bell, RESset_bell = pickle.load(open("../results/A_Poisson/bell","r"))
Vset_myo, Aset_myo, RESset_myo = pickle.load(open("../results/A_Poisson/myo","r"))
Vset_zero, Aset_zero, RESset_zero = pickle.load(open("../results/A_Poisson/zero","r"))
Vset_one, Aset_one, RESset_one = pickle.load(open("../results/A_Poisson/one","r"))
Vset_rnd, Aset_rnd, RESset_rnd = pickle.load(open("../results/A_Poisson/rnd","r"))
...
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.7, 0.6), fontsize=12, ncol=1,fancybox=True,shadow=True)
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
# xlim([2,31])
# ylim([0.6,0.9])
