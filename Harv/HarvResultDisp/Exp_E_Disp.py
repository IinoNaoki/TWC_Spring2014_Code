...
Paramsset = pickle.load(open("../results/E_changing/paramsset","r"))

Vset_bell, Aset_bell, RESset_bell = pickle.load(open("../results/E_changing/bell","r"))
Vset_myo, Aset_myo, RESset_myo = pickle.load(open("../results/E_changing/myo","r"))
Vset_zero, Aset_zero, RESset_zero = pickle.load(open("../results/E_changing/zero","r"))
Vset_one, Aset_one, RESset_one = pickle.load(open("../results/E_changing/one","r"))
Vset_rnd, Aset_rnd, RESset_rnd = pickle.load(open("../results/E_changing/rnd","r"))
...
xlabel('Total energy storage capacity $E$',fontsize=16)
...
xlabel('Total energy storage capacity $E$',fontsize=16)
ylabel('Steady state charging rate',fontsize=16)
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.40,0.65), fontsize=12, ncol=2,fancybox=True,shadow=True)
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
...
subplots_adjust(top=0.93,bottom=0.16,left=0.12, right=0.95)
legend(loc=(0.40,0.18), fontsize=12, ncol=2,fancybox=True,shadow=True)
locs, labels = plt.yticks()
plt.setp(labels, rotation=90)
# xlim([2,31])
# ylim([0.6,0.9])
